...
Parameter
    Y_offgas(s,t,fuel_all)  "off-gas yield (t/t fuel)";
    
* Off-gas yield (t off-gas per t fuel in SAF) – SiMn path
Parameter
    Y_offgas_smn(s,t,fuel_all)  "off-gas yield in SiMn path (t/t fuel)";
...
CCO2_offgas_def(t).. CO2_offgas(t) =e= ( sum(s, gOffgas(s,t)) - D_offgas(t) ) * EF_flare;
...
execute_unload 'output_test.gdx' CO2_offgas.l, pFeMn.l, pSiMn.l, pSinter.l, bSinter.l, eSaf.l, eSint.l;
*-----------------------------*
...
* === After: Solve FeMn_SiMn_Opt using LP minimizing TotalCost; ===
